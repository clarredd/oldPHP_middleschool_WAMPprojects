...
if($suma===0){
	echo "<h1 style='color:red;'>Nema dovoljno podataka za obradu po preocentima</h1>";
}else{
	echo "<table border='1'><tbody>";
	echo "<tr><th>Tip odgovora</th><th>Broj odgovora</th><th>Udeo</th></tr>";
	echo "<tr><td>tačan</td><td>".$brojTacnih."</td><td>".(($brojTacnih/$suma)*100)."%</td></tr>";
	echo "<tr><td>netačan</td><td>".$brojNetacnih."</td><td>".(($brojNetacnih/$suma)*100)."%</td></tr>";
	echo "</tbody></table>";
}
